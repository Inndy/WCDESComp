...
constructor TWCDESComp.Create (AOwner: TComponent);
begin
  inherited Create (AOwner);
end;

destructor TWCDESComp.Destroy;
begin
  inherited Destroy;
end;

procedure TWCDESComp.initPermutation(var inData: Array of Byte);
var
...
procedure TWCDESComp.conversePermutation(var inData: Array of Byte);
var
  newData: Array[0..7] of Byte;
  i: Integer;
begin
...
procedure TWCDESComp.expand(inData: Array of Byte; var outData: Array of Byte);
var
  i: Integer;
begin
...
procedure TWCDESComp.permutation(var inData: Array of Byte);
var
...
function TWCDESComp.si(s,inByte: Byte): Byte;
var
  c: Byte;
begin
...
procedure TWCDESComp.permutationChoose1(inData: Array of Byte;
...
procedure TWCDESComp.permutationChoose2(inData: Array of Byte;
  var outData: Array of Byte);
var
  i: Integer;
begin
...
procedure TWCDESComp.cycleMove(var inData: Array of Byte; bitMove: Byte);
var
  i: Integer;
begin
...
procedure TWCDESComp.makeKey(inKey: Array of Byte; var outKey: Array of TKeyByte);
const
...
procedure TWCDESComp.encry(inData, subKey: Array of Byte;
   var outData: Array of Byte);
var
...
procedure TWCDESComp.desData(desMode: TDesMode;
...
function TWCDESComp.EncryStr(Str, Key: String): String;
var
...
function TWCDESComp.DecryStr(Str, Key: String): String;
var
  StrByte, OutByte, KeyByte: Array[0..7] of Byte;
  StrResult: String;
  I, J: Integer;
...
function TWCDESComp.EncryStrHex(Str, Key: String): String;
var
...
function TWCDESComp.DecryStrHex(StrHex, Key: String): String;
...
procedure Register;
begin
  RegisterComponents('Samples', [TWCDESComp]);
end;
